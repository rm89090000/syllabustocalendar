...
exports.parseSyllabus = parseSyllabus;
function detectTaskType(text) {
    const lower = text.toLowerCase();
    if (lower.includes("exam") || lower.includes("final") || lower.includes("oral argument"))
        return "exam";
...
function parseDateLine(line, fallbackYear = 2025) {
    const monthMap = {
...
function parseSyllabus(text, fallbackYear = 2025) {
